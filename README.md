...
<table><tr><td valign="center"><img alt="Eggspress app icon" src="public/assets/icon-36.webp"/> <strong>Eggspress: The lightweight blog that anyone can deploy</strong> </td></tr></table>
