...
const NavigationMenu = async ({children}: NavigationMenuProps) => {
  ...
  return (
    <div className={`font-medium ${appearanceSettings.colorNavMenuTextDark ? `dark:text-${appearanceSettings.colorNavMenuTextDark}` : 'dark:text-gray-200'} ${appearanceSettings.colorNavMenuTextLight ? `text-${appearanceSettings.colorNavMenuTextLight}` : 'text-gray-800'}`}>
      <div className={`rounded-lg bg-opacity-50 ${appearanceSettings.colorNavMenuBackgroundShadowLight ? 'bg-' + appearanceSettings.colorNavMenuBackgroundShadowLight : 'bg-gray-500'} ${appearanceSettings.colorNavMenuBackgroundShadowDark ? 'dark:bg-' + appearanceSettings.colorNavMenuBackgroundShadowDark : 'dark:bg-gray-500'}`}>
