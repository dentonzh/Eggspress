...
const PaginationCard = ({currentPage, startIndex, endIndex, postCount, type, slug}: {currentPage: string | number, startIndex: number, endIndex: number, postCount: number, type?: string, slug?: string}) => {
